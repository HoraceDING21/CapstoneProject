...
def parse_args():
    ...
    parser.add_argument(
        "--conf", type=float, default=0.01, help="Confidence threshold for NMS (matches mmpose score_thr)"
    )
    parser.add_argument("--iou", type=float, default=0.65, help="IoU threshold for NMS (matches mmpose nms_thr)")
    parser.add_argument(
        "--max-det",
        type=int,
        default=100000,
